...
import com.peliculandia.pop.adapters.LiveTvAdapter2;
import com.peliculandia.pop.adapters.SearchAdapter;
import com.peliculandia.pop.network.RetrofitClient;
import com.peliculandia.pop.network.apis.SearchApi;
import com.peliculandia.pop.network.model.CommonModel;
import com.peliculandia.pop.network.model.SearchModel;
import com.peliculandia.pop.network.model.TvModel;
...
public class SearchResultActivity extends AppCompatActivity implements SearchAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tituloresultados = getString(R.string.resultadostitulo);

        searchQueryTv.setText(tituloresultados + query);

        progressBar=findViewById(R.id.item_progress_bar);
        shimmerFrameLayout=findViewById(R.id.shimmer_view_container);
        shimmerFrameLayout.startShimmer();

        String titulo = getString(R.string.resultadosbusq);
