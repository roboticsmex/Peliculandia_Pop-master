...
public class VideoPlayercopia2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utils.isEmulator())
            finishAndRemoveTask();
        // Set context
        mContext = VideoPlayercopia2.this;
    ...
    private void openPlayer() {
        ...
        mExoLock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                VideoPlayercopia2.this.lockPlayerControls(locked);
            }
        });
        ...
        playerView.setControllerVisibilityListener(new PlayerControlView.VisibilityListener() {
            ...
            public void onVisibilityChange(int visibility) {
                if (visibility == View.VISIBLE) {
                    if (!locked)
                        VideoPlayercopia2.this.showActionBar(true);
                } else {
                    VideoPlayercopia2.this.showActionBar(false);
                }
            }
        });
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                            ...
                            public void onAdDismissedFullScreenContent() {
                                ...
                                Log.d("toalla","El anuncio fue descartado");
                            ...
                            public void onAdFailedToShowFullScreenContent(@NonNull AdError adError) {
                                Log.d("toalla","El anuncio no se mostró");
                                player.setPlayWhenReady(true);
                            }
                            ...
                            public void onAdShowedFullScreenContent() {
                              ...
                              //  Log.d(TAG, "Se mostró el anuncio.");
                                Log.d("toalla","Se mostró el anuncio");
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                      //  Log.i(TAG, loadAdError.getMessage());
                        ...
                        Log.d("toalla","error 1 "+loadAdError.getMessage());
                        ...
                        new CountDownTimer(10000, 1000) {
                            ...
                            public void onTick(long millisUntilFinished) {
                              //  Log.d(TAG, "Sec:" + millisUntilFinished / 1000);
                                ...
                                Log.d("toalla","sec "+ millisUntilFinished / 1000);
                            }

                            @Override
                            public void onFinish() {
                                Log.d("toalla","Recarga de anuncio");
                                loadFullScreenAd();
                            }
                        }.start();
