...
import static com.peliculandia.pop.utils.Constants.CATEGORY_TYPE;
import static com.peliculandia.pop.utils.Constants.CONTENT_ID;
import static com.peliculandia.pop.utils.Constants.CONTENT_TITLE;
import static com.peliculandia.pop.utils.Constants.IMAGE_URL;
import static com.peliculandia.pop.utils.Constants.IS_FROM_CONTINUE_WATCHING;
import static com.peliculandia.pop.utils.Constants.POSITION;
import static com.peliculandia.pop.utils.Constants.SERVER_TYPE;
import static com.peliculandia.pop.utils.Constants.STREAM_URL;
import static com.peliculandia.pop.utils.Constants.YOUTUBE;
import static com.peliculandia.pop.utils.Constants.YOUTUBE_LIVE;
...
import com.peliculandia.pop.activities.VideoPlayer;
import com.peliculandia.pop.adapters.CastCrewAdapter;
import com.peliculandia.pop.adapters.CommentsAdapter;
import com.peliculandia.pop.adapters.DownloadAdapter;
import com.peliculandia.pop.adapters.DownloadsAdapter;
import com.peliculandia.pop.adapters.EpisodeAdapter;
import com.peliculandia.pop.adapters.EpisodeDownloadAdapter;
import com.peliculandia.pop.adapters.HomePageAdapter;
import com.peliculandia.pop.adapters.ProgramAdapter;
import com.peliculandia.pop.adapters.RelatedTvAdapter;
import com.peliculandia.pop.adapters.ServerAdapter;
import com.peliculandia.pop.database.DatabaseHelper;
import com.peliculandia.pop.database.continueWatching.ContinueWatchingModel;
import com.peliculandia.pop.database.continueWatching.ContinueWatchingViewModel;
import com.peliculandia.pop.database.downlaod.DownloadViewModel;
import com.peliculandia.pop.extractor.ExtractorCore;
import com.peliculandia.pop.models.CastCrew;
import com.peliculandia.pop.models.CommonModels;
import com.peliculandia.pop.models.EpiModel;
import com.peliculandia.pop.models.GetCommentsModel;
import com.peliculandia.pop.models.PostCommentModel;
import com.peliculandia.pop.models.Program;
import com.peliculandia.pop.models.SubtitleModel;
import com.peliculandia.pop.models.single_details.Cast;
import com.peliculandia.pop.models.single_details.Director;
import com.peliculandia.pop.models.single_details.DownloadLink;
import com.peliculandia.pop.models.single_details.Episode;
import com.peliculandia.pop.models.single_details.Genre;
import com.peliculandia.pop.models.single_details.RelatedMovie;
import com.peliculandia.pop.models.single_details.Season;
import com.peliculandia.pop.models.single_details.SingleDetails;
import com.peliculandia.pop.models.single_details.Subtitle;
import com.peliculandia.pop.models.single_details.Video;
import com.peliculandia.pop.models.single_details_tv.AdditionalMediaSource;
import com.peliculandia.pop.models.single_details_tv.AllTvChannel;
import com.peliculandia.pop.models.single_details_tv.ProgramGuide;
import com.peliculandia.pop.models.single_details_tv.SingleDetailsTV;
import com.peliculandia.pop.network.RetrofitClient;
import com.peliculandia.pop.network.apis.CommentApi;
import com.peliculandia.pop.network.apis.FavouriteApi;
import com.peliculandia.pop.network.apis.ReportApi;
import com.peliculandia.pop.network.apis.SingleDetailsApi;
import com.peliculandia.pop.network.apis.SingleDetailsTVApi;
import com.peliculandia.pop.network.apis.SubscriptionApi;
import com.peliculandia.pop.network.model.ActiveStatus;
import com.peliculandia.pop.network.model.FavoriteModel;
...
import com.peliculandia.pop.utils.RtlUtils;
import com.peliculandia.pop.utils.ToastMsg;
import com.peliculandia.pop.utils.Tools;
import com.peliculandia.pop.utils.TrackSelectionDialog;
...
public class DetailsActivity extends AppCompatActivity implements ProgramAdapter.OnProgramClickListener, EpisodeAdapter.OnTVSeriesEpisodeItemClickListener,
  ...
  //  private CastPlayer castPlayer;
    ...
    public static String obtienevalor = "1"; //aqui guardo la liga de reproduccion de la base
    String almacenaFuente;
    //  String almacenaIdVideo = "W3Mm2AAyAViqbK";
    String almacenaIdVideo;
    String login = "5e19ad2f145d69fad1a6";
    String key = "BB9bVbA9MosyDdm";

    public String token;
    String tokencontentvideo = "1";
    Thread t = null;
    ...
    public static TextView txtalmacenaUrlSerie;

    public static String almacenaUrlSerie;

    private RequestQueue queue;
    //***************

    String urlServidorm3u8;
    ...
    class DataCreator extends Thread {
        ...
        void prepareData() {
            synchronized (monitor) {
                ...
                String url = "https://api.streamtape.com/file/dlticket?file=W3Mm2AAyAViqbK&login=5e19ad2f145d69fad1a6&key=BB9bVbA9MosyDdm";
                ...
                JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            token = response.getString("ticket");
                            //  cajaticket.setText(token);
                            Log.d("paco", token);

                            new Timer().schedule(new TimerTask() {
                                @Override
                                public void run() {
                                    // // este código se ejecutará después de 6 segundos
                                    generando_url_video();
                                }
                            }, 5000);
                ...
                DetailsActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        //     Toast.makeText(DetailsActivity.this, "Datos preparados 2!", Toast.LENGTH_SHORT).show();
                    }
                });
                ready = true;
                monitor.notifyAll();
    ...
    class DataSender extends Thread {
        ...
        void sendData() {
            ...
            DetailsActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    //     Toast.makeText(DetailsActivity.this, "Esperando datos 1...", Toast.LENGTH_SHORT).show();
                }
            });
            ...
            synchronized (monitor) {
                while (!ready) {
                    try {
                        ...
                        DetailsActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(DetailsActivity.this, "datos no encontrados ...", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                DetailsActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        //     Toast.makeText(DetailsActivity.this, "creando token...", Toast.LENGTH_SHORT).show();
    ...
    public void initViews() {
        ...
        txtalmacenaUrlSerie = findViewById(R.id.almacenaserie);
    ...
    protected void onStart() {
        ...
        watchNowBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(obtienevalor.equals("1"))
                {
                    Toast.makeText(mContext, "NO TIENE PELICULA REPORTAR", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    if (almacenaFuente.equals("streamtape.com")) {
                        //      Toast.makeText(DetailsActivity.this, "ejecuta segundo motor", Toast.LENGTH_SHORT).show();

                        //   Log.d("panda","el token es "+tokencontentvideo);

                        if(tokencontentvideo.equals("1"))
                        {
                            Toast.makeText(DetailsActivity.this, "estamos generando tu token regalanos unos segundos", Toast.LENGTH_SHORT).show();

                            watchNowBt.setEnabled(false);
                            new Timer().schedule(new TimerTask() {
                                @Override
                                public void run() {
                                    // // este código se ejecutará después de 6 segundos
                                    if(tokencontentvideo.equals(""))
                                    {
                                        Toast.makeText(DetailsActivity.this, "reproducir desde navegador", Toast.LENGTH_SHORT).show();
                                    }else {
                                        //     watchNowBt.setEnabled(true);
                                        //aqui va para reproducir los mp4
                                    /*
                                    Intent intent = new Intent(DetailsActivity.this, selectvideonline.class);
                                    intent.putExtra("Nombreurl", tokencontentvideo);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK); //PARA QUE EL BORRAR LA ACTIVIDAD COMPLETA Y NO REGRESAR AQUI
                                    //      Toast.makeText(videoplayerUrl.this, "parametro enviado "+urlExternal.toString(), Toast.LENGTH_SHORT).show();
                        ...
                        }else
                        {
                             ...
                             */
                                ContinueWatchingModel model = new ContinueWatchingModel(id, title, castImageUrl, 0, 0, tokencontentvideo, categoryType, "vimeo");
                                viewModel.insert(model);
                            }
                        }

                    }else if(almacenaFuente.equals("vidoza.net")){

                        startWork(UrlMode.PLAY);
                        ...
                        startActivity(
                                new Intent(mContext, VideoPlayer.class)
                                        ...
                                        .putExtra("urlImagenPortada", castImageUrl)
                                        .putExtra("tituloMovie", title)
                                        .putExtra("url", urlServidorm3u8)
                                        .putExtra("referer", urlServidorm3u8)
    ...
    private void reportMovie() {
        ...
        movieTitle.setText("Reporte para: " + title);
        if (!isDark) {
...
, new YouTubePlayer.OnInitializedListener() {
    ...
    public void setSelectedSubtitle(MediaSource mediaSource, String subtitle, Context context) {
        ...
        if (subtitle != null) {
            ...
            Format subtitleFormat = Format.createTextSampleFormat(
                    ...
                    "es"); // The subtitle language. May be null.
        ...
        call.enqueue(new Callback<SingleDetails>() {
            ...
            public void onResponse(Call<SingleDetails> call, Response<SingleDetails> response) {
                if (response.code() == 200) {
                    ...
                    seriesTitle = title;
                    tvName.setText(title);
                    tvRelease.setText("Disponible en " + singleDetails.getRelease());
        ...
        call.enqueue(new Callback<SingleDetails>() {
            ...
            public void onResponse(Call<SingleDetails> call, Response<SingleDetails> response) {
                if (response.code() == 200) {
                    ...
                    tvName.setText(title);
                    tvRelease.setText("Fecha de Estreno: " + singleDetails.getRelease());
                    tvDes.setText(singleDetails.getDescription());
                    ...
                    for (int i = 0; i < serverList.size(); i++) {
                        ...
                        obtienevalor = models.getStremURL().toString();
                        urlServidorm3u8 = models.getStremURL().toString();
                        // almacenaIdVideo = models.getStremURL().toString();
                        Log.d("panda", obtienevalor);

                        almacenaFuente = obtienevalor.split("/")[2];
                        Log.d("panda", almacenaFuente);

                        if (almacenaFuente.equals("streamtape.com")) {
                            almacenaIdVideo = obtienevalor.split("/")[4];
                            Log.d("panda", almacenaIdVideo);
                        } else {
                            almacenaIdVideo = "";
                        }
                        ...
                        if (almacenaFuente.equals("streamtape.com")) {
                            ...
                            new DetailsActivity.DataSender();
                            new DetailsActivity.DataCreator();
                            //    Toast.makeText(DetailsActivity.this, "si es Streamtape . com", Toast.LENGTH_SHORT).show();
    ...
    public void objet_ticket() {
        Handler handle2 = new Handler();
        Runnable r2 = new Runnable() {
            public void run() {

                long tInicio = System.currentTimeMillis();
                String url = "https://api.streamtape.com/file/dlticket?file=" + almacenaIdVideo + "&login=" + login + "&key=" + key;
                ...
                JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Log.d("paco",String.valueOf(tDiferencia)+  " millisegundos.");
                            ...
                            //      Toast.makeText(DetailsActivity.this, "Ticket Omar: " + token, Toast.LENGTH_LONG).show();
                            objet_url();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                ...
                queue.add(request);
                //      objet_url();
                //  Toast.makeText(DetailsActivity.this, "Omar "+token, Toast.LENGTH_SHORT).show();
                //  cuerpotexto1();
            }
        };
        handle2.postDelayed(r2, 6000);

    }

    public void objet_url() {
        long tInicio2 = System.currentTimeMillis();
        String url = "https://api.streamtape.com/file/dl?file=" + almacenaIdVideo + "&ticket=" + token;
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new com.android.volley.Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    long tDiferencia2 = tFinal2 - tInicio2;
                    Log.d("paco",String.valueOf(tDiferencia2)+  " millisegundos del metodo2.");
                    response = response.getJSONObject("result");
                    tokencontentvideo = response.getString("url");
                    Log.d("paco", tokencontentvideo);
                    Toast.makeText(DetailsActivity.this, "Url:" + tokencontentvideo, Toast.LENGTH_LONG).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
    ...
    public void generando_url_video() {
        String t = "W3Mm2AAyAViqbK~5e19ad2f145d69fad1a6~1626836262~n~~1~30Kb4Q7FzWdR08s1";
        String url = "https://api.streamtape.com/file/dl?file=W3Mm2AAyAViqbK&ticket=" + token;
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new com.android.volley.Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    response = response.getJSONObject("result");
                    tokencontentvideo = response.getString("url");
                    //  cajaticketfinal.setText(pelicula);
                    Log.d("panda","soy la pelicula linea 3203 "+tokencontentvideo);
                    //   Toast.makeText(pruebavideo.this, "Url:"+pelicula, Toast.LENGTH_LONG).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
    ...
    public void startWork(UrlMode mode) {

        if(txtalmacenaUrlSerie.getText().toString().equals(""))
        {
            url = obtienevalor;
        }else
        {
            url = txtalmacenaUrlSerie.getText().toString();
        }
    ...
    public void abreSerieVideoPlayer() {
        startActivity(
                new Intent(mContext, VideoPlayer.class)
                        .putExtra("title", videoTitle)
                        .putExtra("urlImagenPortada", castImageUrl)
                        .putExtra("tituloMovie", title)
                        .putExtra("url", txtalmacenaUrlSerie.getText().toString())
                        .putExtra("referer", txtalmacenaUrlSerie.getText().toString())
                        .putExtra("stream", true));
    }
    ...
    private void continueWork(String finalURL, UrlMode mode){
                ...
                case PLAY:
                    startActivity(
                            new Intent(mContext, VideoPlayer.class)
                                    ...
                                    .putExtra("stream", true));
                 //   StartAppAd.showAd(DetailsActivity.this);
                    Toast.makeText(mContext, "estamos cargando tu pelicula espera porfavor...", Toast.LENGTH_SHORT).show();
                    break;
                case SHARE:
                    startActivity(
        ...
        {
            // Widget.notify(mContext.getString(R.string.extraction_error), mContext,  SweetAlertDialog.ERROR_TYPE);
            //  Toast.makeText(mContext, "tokenizando de nuevo", Toast.LENGTH_SHORT).show();
            startWork(UrlMode.PLAY);
        }
    }
