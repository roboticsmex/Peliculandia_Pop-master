...
import com.peliculandia.pop.widget.RangeSeekBar;
...
public class SearchActivity extends AppCompatActivity {
    ...
    String year_min = "1900";
    String year_max = "2020";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nombretitulo = getString(R.string.Buscar);
    ...
    private void initComponent() {
        ...
        range_seek_bar.setOnRangeSeekbarChangeListener(new OnRangeSeekbarChangeListener() {
            ...
            public void valueChanged(Number minValue, Number maxValue) {
                year_min = String.valueOf(minValue);
                year_max = String.valueOf(maxValue);
            }
        });
    ...
    private void search() {
        ...
        int range_from = Integer.parseInt(year_min);
        int range_to = Integer.parseInt(year_max);
